...
{
    public interface IDisplayLooseInfo : IComparable<Individual>, IColumnComparer<IDisplayLooseInfo>
    {
        [ColumnDetail("Ref", 60)]
        ...
        [ColumnDetail("Birth Can be updated to", 300)]
        string LooseBirth { get; }
        [ColumnDetail("Death Can be updated to", 300)]
